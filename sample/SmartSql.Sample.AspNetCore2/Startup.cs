...
namespace SmartSql.Sample.AspNetCore2
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
              ...
              .AddRepositoryFromAssembly(o =>
              {
                   ...
                   o.AssemblyString = "SmartSql.Sample.AspNetCore2";
                  o.Filter = (type) => type.Namespace == "SmartSql.Sample.AspNetCore2.DyRepositories";
              })
