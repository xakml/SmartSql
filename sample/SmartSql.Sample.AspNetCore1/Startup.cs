...
namespace SmartSql.Sample.AspNetCore1
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
               ...
               .AddRepositoryFromAssembly(o =>
               {
                   ...
                   o.AssemblyString = "SmartSql.Sample.AspNetCore1";
                   o.Filter = (type) => type.Namespace == "SmartSql.Sample.AspNetCore1.DyRepositories";
               })
